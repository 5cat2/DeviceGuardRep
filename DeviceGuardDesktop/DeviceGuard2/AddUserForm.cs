...
namespace DeviceGuard2
{
    ...
    {
        private readonly string _connectionString = "Data Source=DESKTOP-N2NP29H\\SQLEXPRESS;Initial Catalog=TechSupportDB;Integrated Security=True;TrustServerCertificate=True";
        public AddUserForm()
        {
            InitializeComponent();
        }
